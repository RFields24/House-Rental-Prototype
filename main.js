...
const getProperty = async() => {
  ...
  if (props.length >= 7) { // defensive coding!!
    for (let indexCounter = 1; indexCounter < 7; indexCounter ++) { 
...
// // HANDLES CLICKS OF INDIVIDUAL PROPERTIES TO GET DETAILS(ONLY WORKS ON FIRST PROPERTY) NEED TO FIND OUT HOW TO PULL PROPERTY ID TO PUT INTO DETAIL API CALL
